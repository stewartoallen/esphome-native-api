...
class EsphomeNativeApiConnection extends EventEmitter {
    ...
    subscribeVoiceAssistantService(
        subscribe = true,
        ...
        console.log('SUBSCRIBE VOICE', message.toObject());
        this.sendMessage(message);
    }
    ...
    subscribeHomeAssistantServices() {
        ...
        console.log('SUBSCRIBE HA SERVICES', message.toObject());
        this.sendMessage(message);
    }
    ...
    subscribeHomeAssistantStatesService(
        ...
        console.log('SUBSCRIBE HA STATE', message.toObject());
        this.sendMessage(message);
    }
